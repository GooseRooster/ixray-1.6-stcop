...
//	add_evaluator		(uid(id,eWorldPropertyThrowIdle)	,new CObjectPropertyEvaluatorMissile(missile,m_object,MS_THROW));
	add_evaluator		(uid(id,eWorldPropertyThrow)		,new CObjectPropertyEvaluatorMissile(missile,m_object,CMissile::eThrowEnd));
