...
void CStalkerDangerUnknownPlanner::add_evaluators			()
{
	...
	add_evaluator			(eWorldPropertyCoverActual		,new CStalkerPropertyEvaluatorDangerUnknownCoverActual	(m_object,"danger unknown : cover actual"));
	add_evaluator			(eWorldPropertyCoverReached		,new CStalkerPropertyEvaluatorMember					((CPropertyStorage*)0,eWorldPropertyCoverReached,true,true,"danger unknown : cover reached"));
	add_evaluator			(eWorldPropertyLookedAround		,new CStalkerPropertyEvaluatorMember					((CPropertyStorage*)0,eWorldPropertyLookedAround,true,true,"danger unknown : looked around"));
}
