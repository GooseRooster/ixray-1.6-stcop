	...
	[
		...
		class_<key_binding_registrator >("DIK_keys")
			...
			[
                ...
                value("DIK_INTERNATIONAL1", int(SDL_SCANCODE_INTERNATIONAL1)),
                value("DIK_INTERNATIONAL2", int(SDL_SCANCODE_INTERNATIONAL2)),
                value("DIK_YEN", int(SDL_SCANCODE_INTERNATIONAL3)),
                value("DIK_INTERNATIONAL4", int(SDL_SCANCODE_INTERNATIONAL4)),
                value("DIK_INTERNATIONAL5", int(SDL_SCANCODE_INTERNATIONAL5)),
                value("DIK_INTERNATIONAL6", int(SDL_SCANCODE_INTERNATIONAL6)),
                value("DIK_INTERNATIONAL7", int(SDL_SCANCODE_INTERNATIONAL7)),
                value("DIK_INTERNATIONAL8", int(SDL_SCANCODE_INTERNATIONAL8)),
                value("DIK_INTERNATIONAL9", int(SDL_SCANCODE_INTERNATIONAL9)),
                ...
                value("DIK_LANG6", int(SDL_SCANCODE_LANG6)),
                value("DIK_LANG7", int(SDL_SCANCODE_LANG7)),
                value("DIK_LANG8", int(SDL_SCANCODE_LANG8)),
                value("DIK_LANG9", int(SDL_SCANCODE_LANG9)),
