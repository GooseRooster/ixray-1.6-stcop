...
public:
	sight_manager_enable_guard(const sight_manager_enable_guard& other) = delete;
	sight_manager_enable_guard& operator=(const sight_manager_enable_guard& other) = delete;
